class PatientsController < ApplicationController
  ...
  def update_profile #TODO##
    ...
    if current_user.user_record.update_attributes(:contact_number => params[:contact_number],
  :date_of_birth => @date, :blood_group => @blood_group.name, :gender => params[:gender],
