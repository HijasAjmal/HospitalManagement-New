authorization do
  role :admin do
    ...
    has_permission_on [:patients], :to => [:index, :details_view_admin, :delete, :patient_list]
    has_permission_on [:departments], :to => [:index, :create_department, :new, :delete, :department_list]
